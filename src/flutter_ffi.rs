...
// --- beta lock ffi ---
pub fn beta_needs_password() -> SyncReturn<bool> {
    SyncReturn(crate::beta_lock::needs_password())
}

pub fn beta_verify_password(password: String) -> SyncReturn<bool> {
    SyncReturn(crate::beta_lock::verify_password(&password))
}

pub fn beta_get_remaining_seconds() -> SyncReturn<i64> {
    SyncReturn(crate::beta_lock::get_remaining_seconds())
}

pub fn beta_is_expired() -> SyncReturn<bool> {
    SyncReturn(crate::beta_lock::is_expired())
}

pub fn beta_is_verified() -> SyncReturn<bool> {
    SyncReturn(crate::beta_lock::is_verified())
}

pub fn beta_init_first_run() {
