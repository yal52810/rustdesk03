...
import 'package:flutter_hbb/common/widgets/beta_lock.dart';
import 'common.dart';
import 'consts.dart';
...
/// Beta lock: set to true for password-protected beta build
const kBetaLocked = bool.fromEnvironment('BETA_LOCKED', defaultValue: false);
...
class _AppState extends State<App> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshWrapper(builder: (context) {
      return BetaLockWidget(
        enabled: kBetaLocked && isDesktop,
        child: MultiProvider(
          providers: [
